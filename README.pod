...
=item * To make all parts of its behaviour easy to augment
...
You might want to override this method in your view class to modify
the result of merging all static class configuration.
...
or from the C<$template> passed explicitly if one was.
...
Any trailing extra arguments you pass this method will be passed
to all of L</render>, L</process_output> and L</process_error>.

You might want to override this method in your view class
...
In other words, the default implementation is a shorthand for this:
...
You might want to override this method in your view class in order
to send the output somewhere other than the HTTP response, e.g. e-mail.
...
You are unlikely to want to override this method in your view class
except maybe in some kind of ancillary view (or something of the sort)
